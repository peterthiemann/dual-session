...
\end{array}
\]
\AgdaCounterparts{newest-variable substitution and unrolling
\AgdaName{Types.IND1}{subst0}{subst0},
\AgdaName{Types.IND1}{unrollG}{unrollG},
\AgdaName{Types.IND1}{unroll}{unroll}, and
\AgdaName{Types.IND1}{unfold}{unfold}; stopped duality
...
provides symmetry
\AgdaMathName{DualStopAtMu}{2593}{$\mathsf{symm}$} and inversion
\AgdaMathName{DualStopAtMu}{3103}{$\mathsf{inv}$} lemmas.
...
\AgdaName{Types.IND1}{substT}{substT}.  Substitution for the newest variable
is \AgdaName{Types.IND1}{subst0}{subst0}; the canonical one-step unfolding
operations are \AgdaName{Types.IND1}{unrollG}{unrollG} and
\AgdaName{Types.IND1}{unroll}{unroll}, with closed observation through
\AgdaName{Types.IND1}{unfold}{unfold}.  Every type representation now
